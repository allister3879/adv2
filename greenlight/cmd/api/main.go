...
import (
	...
	"greenlight.d.net/internal/jsonlog"
	"greenlight.d.net/internal/mailer"
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgres:3879@localhost:5432/d.narynbekovaDB?sslmode=disable", "PostgreSQL DSN")
